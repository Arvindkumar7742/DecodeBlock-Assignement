...
const Blocks = ["Label", "Input","Select","CheckBox","Button"];
...
export const Sidebar = () => {
    ...
    return (
        <div className='bg-black w-full lg:w-1/4 md:w-1/3 h-full p-4'>
            <p className='text-white mt-2 ml-2 text-lg'>Blocks</p>
