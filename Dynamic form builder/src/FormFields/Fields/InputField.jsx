...
export const InputField = ({ data,id,setFormData }) => {
  ...
  return (
    <div className="flex flex-wrap items-center gap-1 py-3 px-4 border rounded-lg shadow-sm w-full sm:w-[95%] md:w-[60%] lg:w-[50%] mt-2 mx-auto">
      ...
      {
        openEditModal && <Modal setFormData={setFormData} openModal={{field:"input"}} editFlag={editFlag} setEditFlag={setEditFlag} setEditOpenModal={setEditOpenModal} modalData={modalData} setModalData={setModalData} />
      }
    </div>
  );
};
